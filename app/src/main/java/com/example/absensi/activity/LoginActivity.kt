...
import com.example.absensi.activity.admin.AdminActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    fun clickView() {
        buttonLogin.setOnClickListener {
            ...
            firestore.collection("users").whereEqualTo("username", email)
                ...
                .addOnSuccessListener { documentSnapshot ->
                    ...
                    editor.putString(
                        "userUsername",
                        documentSnapshot.documents[0].getString("username")
                    )
                    editor.apply()
